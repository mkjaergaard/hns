...
int main()
{
  ...
  hns::TagHandle h1 = server.registerTag("ns1/t1_1");
  hns::TagHandle h2 = server.registerTag("ns1/ns1_1/t1_1_1");
  hns::TagHandle h3 = server.registerTag("ns1/ns1_1/t1_1_2");
  hns::TagHandle h4 = server.registerTag("ns1/ns1_2/t1_2_1");
  hns::TagHandle h5 = server.registerTag("ns2/ns2_1/t2_1_1");
  hns::TagHandle h6 = server.registerTag("ns2/ns2_2/t2_2_1");
  ...
  // Subscribe
  h1.addSubscriber(boost::bind(&callback, _1, _2, _3));
}
